...
* After integrating the design with user's testbench, the user needs to add
  these files (testbench files, toplevel wrapper file) in ddr2_512M16_mig.prj under
  synth folder.
...
* ddr2_512M16_mig.ucf file is the constraint file for the design. This is used
...
* "icon_coregen.xco", "ila_coregen.xco" and "vio_coregen.xco" files are
  ...
  ChipScope modules i.e., ila and icon in the ddr2_512M16_mig rtl file.
...
* At the start of a Chip Scope Analyzer project, all of the signals in
  every core have generic names. "ddr2_512M16_mig.cdc" is a file that contains
  all the signal names of all cores. Upon importing this file, signal names are
  renamed to the specified names in "ddr2_512M16_mig.cdc" file. This file will work
...
Note : When you generate the design using "Debug Signals for Memory Controller"
       ...
       into ise_flow.bat and create_ise.bat files. The ddr2_512M16_mig rtl file
...
* For example, the design is generated with component name as ddr2_512M16_mig with
  Target FPGA 4000FG1156 and Compatible FPGA 5000FG1156.
   ...
   - Change the UCF file name in batch file to the one in compatible_ucf
     folder i.e., change the UCF name (ddr2_512M16_mig.ucf) in ise_flow.bat and
